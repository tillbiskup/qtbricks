...
latex_documents = [
    (master_doc, 'qtbricks.tex', 'qtbricks Documentation',
     'Till Biskup', 'manual'),
]
...
man_pages = [
    (master_doc, 'qtbricks', 'qtbricks Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'qtbricks', 'qtbricks Documentation',
     author, 'qtbricks', 'Python Qt components: widgets and utils, focussing on scientific GUIs.',
     'Miscellaneous'),
]
